...
let canvas = {
    ...
    */
    start: function(){
        ...
        if(loaded === false){
            ...
            window.requestAnimationFrame(canvas.start.bind(this));
        }else{
            //iniciar canvas
            this.update();
        }
    ...
    */
    draw: function(){
        ...
        window.requestAnimationFrame(canvas.update.bind(canvas));
    },

    /*
    * Agrega las imagenes de los rangos para poder ser animadas, es utilizada por la funcion onClick()
    * @method animate
    * @param {number} rangoInicial- rango en el cual esta la cuenta dewl cliente al momento de contratar el servicio
